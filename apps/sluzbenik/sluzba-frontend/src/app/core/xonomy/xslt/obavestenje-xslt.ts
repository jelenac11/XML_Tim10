export const obavestenjeXSLT = `<?xml version="1.0" encoding="UTF-8"?>
    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                <div class="c1">
                    <textarea class="c34">
                    <xsl:value-of select="concat(/ob:obavestenje/ob:informacije_o_obavestenju/ob:organ/common:naziv, ' ')"></xsl:value-of>                    
                    ...
                    <br/>
                    <p class="c6"><strong>О Б А В Е Ш Т Е Њ Е</strong></p>
                    <p class="c37">
                    ...
                    <p class="c39">
                        <span><tab1>На основу члана 16. ст. 1. Закона о слободном приступу информацијама од јавног значаја, поступајући по вашем захтеву за слободан приступ информацијама од <u><xsl:value-of select="/ob:obavestenje/ob:zahtev/ob:datum_trazenja_informacija"></xsl:value-of></u> год., којим сте тражили увид у документ/е са информацијама о / у вези са: </tab1></span>
                    </p>
                    <textarea rows="3" class="c42">
                        <xsl:value-of select="/ob:obavestenje/ob:zahtev/ob:opis_trazene_informacije"></xsl:value-of>
                    </textarea>
                        ...
                        <xsl:choose>
                            <xsl:when test="contains(/ob:obavestenje/ob:odgovor_na_zahtev/ob:zahtevi/ob:informacije_o_uvidu/@status,'true')">
                                <p class="c39">
                                    ...
                                    у 
                                    <xsl:choose>
                                        <xsl:when test="/ob:obavestenje/ob:odgovor_na_zahtev/ob:zahtevi/ob:informacije_o_uvidu/ob:vreme_uvida/ob:tacno_vreme_uvida">
                                            <u><xsl:value-of select="/ob:obavestenje/ob:odgovor_na_zahtev/ob:zahtevi/ob:informacije_o_uvidu/ob:vreme_uvida/ob:tacno_vreme_uvida"></xsl:value-of></u>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            /
                                        </xsl:otherwise> 
                                    ...
                                    односно у времену 
                                    <xsl:choose>
                                        <xsl:when test="/ob:obavestenje/ob:odgovor_na_zahtev/ob:zahtevi/ob:informacije_o_uvidu/ob:vreme_uvida/ob:interval_uvida">
                                            од <u><xsl:value-of select="/ob:obavestenje/ob:odgovor_na_zahtev/ob:zahtevi/ob:informacije_o_uvidu/ob:vreme_uvida/ob:interval_uvida/ob:od"></xsl:value-of></u> до 
                                            <u><xsl:value-of select="/ob:obavestenje/ob:odgovor_na_zahtev/ob:zahtevi/ob:informacije_o_uvidu/ob:vreme_uvida/ob:interval_uvida/ob:do"></xsl:value-of></u>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            од / до /
                                        </xsl:otherwise> 
                                    ...
                                    <u><xsl:value-of select="/ob:obavestenje/ob:odgovor_na_zahtev/ob:zahtevi/ob:informacije_o_uvidu/ob:mesto_uvida/common:mesto"></xsl:value-of></u> 
                                    ул. <u><xsl:value-of select="/ob:obavestenje/ob:odgovor_na_zahtev/ob:zahtevi/ob:informacije_o_uvidu/ob:mesto_uvida/common:ulica"></xsl:value-of></u> 
                                    бр. <u><xsl:value-of select="/ob:obavestenje/ob:odgovor_na_zahtev/ob:zahtevi/ob:informacije_o_uvidu/ob:mesto_uvida/common:broj"></xsl:value-of></u>, 
                            ...
                            <xsl:when test="contains(/ob:obavestenje/ob:odgovor_na_zahtev/ob:zahtevi/ob:informacije_o_posedovanju/@status,'true')">                                
                                <xsl:choose>
                                    <xsl:when test="contains(/ob:obavestenje/ob:odgovor_na_zahtev/ob:zahtevi/ob:informacije_o_posedovanju/@poseduje,'true')">
                                        <p class="c39">
                                            <tab1>
                                            Овом приликом вас обавештавамо да поседујемо информације које сте навели у захтеву.
                                            </tab1>
                                        </p>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <p class="c39">
                                            <tab1>
                                            Нажалост, не поседујемо информације које сте навели у захтеву.
                                            </tab1>
                                        </p>
                                    </xsl:otherwise> 
                                </xsl:choose>                               
                    ...
                    <xsl:if test="/ob:obavestenje/ob:odgovor_na_zahtev/ob:uplata_troskova">
                        ...
                        <xsl:for-each select="/ob:obavestenje/ob:odgovor_na_zahtev/ob:uplata_troskova/ob:troskovi/ob:trosak"> 
                        <xsl:value-of select="concat(ob:stavka, ' ')"/>
                        <xsl:value-of select="ob:kolicina"/> комад/а износи <xsl:value-of select="ob:jedinicna_cijena"/> динара по комаду
                        </xsl:for-each>.
                        </p>
                        <p class="c39">
                            <tab1>
                            Износ укупних трошкова износи 
                            <u><xsl:value-of select="/ob:obavestenje/ob:odgovor_na_zahtev/ob:uplata_troskova/ob:uplatnica/ob:iznos"></xsl:value-of></u> динара 
                            и уплаћује се на жиро-рачун <u><xsl:value-of select="/ob:obavestenje/ob:odgovor_na_zahtev/ob:uplata_troskova/ob:uplatnica/ob:primalac"></xsl:value-of></u> бр. 
                            <u><xsl:value-of select="/ob:obavestenje/ob:odgovor_na_zahtev/ob:uplata_troskova/ob:uplatnica/ob:racun"></xsl:value-of></u>, с позивом на број 
                            <u><xsl:value-of select="/ob:obavestenje/ob:odgovor_na_zahtev/ob:uplata_troskova/ob:uplatnica/ob:poziv_na_broj"></xsl:value-of></u> – ознака шифре општине/града где се налази орган власти 
                    ...
                    <p class="c40">                                         
                        <xsl:choose>
                            <xsl:when test="/ob:obavestenje/ob:dostavljeno/ob:imenovanom and /ob:obavestenje/ob:dostavljeno/ob:arhivi">
                            1. Именованом 
                            <br/>
                            2. Архиви
                            </xsl:when>   
                            <xsl:when test="/ob:obavestenje/ob:dostavljeno/ob:imenovanom and not(/ob:obavestenje/ob:dostavljeno/ob:arhivi)">
                            1. Именованом 
                            </xsl:when>
                            <xsl:when test="not(/ob:obavestenje/ob:dostavljeno/ob:imenovanom) and /ob:obavestenje/ob:dostavljeno/ob:arhivi">
                            1. Архиви 
                            </xsl:when>
                            <xsl:otherwise>
                            </xsl:otherwise> 
