...
@XmlSeeAlso({
    projectXML.team9.models.obavestenje.Obavestenje.OdgovorNaZahtev.UplataTroskova.class
})
public class TUplatnica {
	...
	public String toString() {
		return String.format("\tPodaci za uplatnicu:\n\t\tPrimalac: %s\n\t\tRacun: %s\n\t\tIznos %.2f\n\t\tPoziv na broj: %s\n\n", primalac, racun, iznos, pozivNaBroj);
	}
    /**
