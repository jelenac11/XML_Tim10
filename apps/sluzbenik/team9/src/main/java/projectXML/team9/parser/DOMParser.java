 ...
 * 
 * Primer omogućuje validaciju XML fajla u odnosu na XML šemu, koja se svodi na
 * postavljanje svojstava factory objekta uz opcionu implementaciju error
 * handling metoda.
 * 
...
public class DOMParser implements ErrorHandler {
	...
	/**
	 * Ispis pojedinih elemenata i atributa DOM stabla upotrebom DOM API-ja.
	 * 
	 * @param elementName
	 */
