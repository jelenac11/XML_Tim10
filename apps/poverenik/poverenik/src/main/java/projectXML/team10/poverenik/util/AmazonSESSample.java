...
import projectXML.team10.poverenik.dto.EmailDTO;
...
public class AmazonSESSample {
	...
	@Async
	public void sendMailWhenResolved(String recipient, String htmlURL, String pdfURL)
		...
		String subject = "Rešenje na žalbu";
		...
		String text = "Poštovani, \n\n"
				+ "Ovim putem želimo da Vas obavestimo da je rešenje, na vašu žalbu.\n\n"
				+ "Takođe, u prilogu Vam dostavljamo i dokument rešenja.\n\n"
				+ "S poštovanjem, \n" + "Služba";
